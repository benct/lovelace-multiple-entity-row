...
[![GH-release](https://img.shields.io/badge/version-3.1.1-red.svg?style=flat-square)](https://raw.githubusercontent.com/benct/lovelace-multiple-entity-row/master/multiple-entity-row.js)
...
```yaml
resources:
  - url: /local/multiple-entity-row.js?v=3.1.1
    type: module
```
