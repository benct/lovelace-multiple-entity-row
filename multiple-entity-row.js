    ...
    class MultipleEntityRow extends LitElement {
                ...
                ? html` <state-badge
                      ...
                      <div class="flex">
                          <div class="info" @click="${this.onRowClick}">
                              ${this.state.name}
                              <div class="secondary" style="${this.state.info && this.state.info.style}">
        ...
        renderSecondaryInfo() {
            if (this.lastChanged)
                return html`<ha-relative-time
                    datetime="${this.state.stateObj.last_changed}"
                    .hass="${this._hass}"
                ></ha-relative-time>`;
            if (this.state.info) {
        ...
        renderIcon(entity) {
            return html`<state-badge
                ...
                .overrideIcon="${entity.icon}"
                .stateColor="${entity.state_color}"
            ></state-badge>`;
        }
        ...
        renderEntity(entity) {
            return entity
                ? html` <div class="entity" style="${entity.style}" @click="${entity.onClick}">
            ...
            if (hass && this._config) {
                ...
                this.state = mainStateObj
                    ? {
                          ...
                          unit:
                              this._config.unit === false
                                  ? null
                                  : this._config.unit || mainStateObj.attributes.unit_of_measurement,
                          ...
                          entities: this._config.entities
                              ? this._config.entities.map((entity) => this.initEntity(entity, mainStateObj))
                              : [],
                          info: this.lastChanged
                              ? null
        ...
        initEntity(config, mainStateObj) {
            ...
            if (!stateObj)
                return {
                    value: this._hass.localize('state.default.unavailable'),
                    unavailable: true,
                };
            ...
            return {
                ...
                unavailable: [UNKNOWN, UNAVAILABLE].includes(
            ...
            if (!config || !config.action || config.action === 'more-info') {
                return () =>
                    this.fireEvent(this, 'hass-more-info', {
                        entityId: (config && config.entity) || entityId,
                    });
            }
